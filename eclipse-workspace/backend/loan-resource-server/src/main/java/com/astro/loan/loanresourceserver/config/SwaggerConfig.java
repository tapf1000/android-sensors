...
/*    @Value("${app.client.id}")
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("Loan Api").description("")
                .termsOfServiceUrl("https://www.example.com/api")
                .contact(new Contact("Clayton", "http://www.example.com", "clayton@astroafrica.tech"))
                .license("Open Source").licenseUrl("https://www.astroafrica.com").version("1.0.0").build();
    }
*/
